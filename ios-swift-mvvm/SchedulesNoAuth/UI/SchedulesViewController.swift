...
class SchedulesViewController: UIViewController {
    ...
    // MARK: - Properties
    private let viewModel: SchedulesNoAuthViewModel
    ...
    // MARK: - Initializer
    init(viewModel: SchedulesNoAuthViewModel = .init()) {
    ...
    // MARK: - Bindings
    private func updateState(_ state: SchedulesNoAuthViewModel.Status) {
...
// MARK: - View Constants
private extension SchedulesViewController {
